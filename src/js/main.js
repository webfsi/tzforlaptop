jQuery(function($){
  ...
  // tabs
  // var tabsList = $('ul.tabs'),
  //     tabsSection = '.box-tabs',
  //     tabsBox = '.box',
  //     tabsBoxActive = 'box_active',
  //     tabsBoxHidden = 'box_hidden';

  // tabsList.on('click', 'li:not(.current)', function() {
  //   $(this)
  //   .addClass('current')
  //   .siblings()
  //   .removeClass('current')
  ...
  //   .find(tabsBox)
  //   .eq($(this).index())
  //   .addClass(tabsBoxActive)
  //   .removeClass(tabsBoxHidden)
  //   .siblings(tabsBox)
  //   .removeClass(tabsBoxActive)
  //   .addClass(tabsBoxHidden);
  // });
  
  // accordion
  // $('.accordion-item').on('click', '.accordion-item__cap', function(){
  //   if($(this).parent().is('.accordion-item_opened')) {
  //     $(this).next().slideUp(300).parents('.accordion-item').removeClass('accordion-item_opened').addClass('accordion-item_hidden');
  //   }else{
  //     $(this).next().slideDown(300).parents('.accordion-item').addClass('accordion-item_opened').removeClass('accordion-item_hidden');
  //   }
  // });
